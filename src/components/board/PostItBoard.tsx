    ...
    if (urlMatch) {
      ...
      nodes.push(
        <button
          key={`url-${index}`}
          type="button"
          className="inline cursor-pointer text-left font-medium text-nb-ink underline decoration-2 underline-offset-2 hover:text-nb-orange"
          onClick={(e) => {
            e.stopPropagation();
      ...
      nodes.push(
        <button
          key={`ticket-${index}`}
          type="button"
          className="inline cursor-pointer text-left font-bold text-nb-ink underline decoration-2 underline-offset-2 hover:text-nb-orange"
          onClick={(e) => {
            e.stopPropagation();
